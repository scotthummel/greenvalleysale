...
<div class="container">
    ...
    <div>
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#furniture" aria-controls="furniture" role="tab" data-toggle="tab">Furniture</a></li>
            ...
            <div role="tabpanel" class="tab-pane active" id="furniture">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <p>Rust chair (dog not included). $200.</p>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <p>Hand-caned antique chairs from late 1800s/early 1900s. One of two. $75.</p>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <p>Antique walnut wash stand with dovetailed drawers. $250.</p>
                    </div>
                    <div class="col-md-4">
                        <img src="/images/33.JPG" class="img-responsive"/>
                        <p>Comfortable chair. $200.</p>
                    </div>
                    <div class="col-md-4">
                        <img src="/images/34.JPG" class="img-responsive"/>
                        <p>Jennifer Sofas hide-a-bed. $200.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <img src="/images/36.JPG" class="img-responsive"/>
                        <p>Contemporary kitchen table and chairs. $125.</p>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <p>Antique dresser with dovetailed drawers from late 1800s/early 1900s. $400.</p>
                    </div>
                    <div class="col-md-4">
            ...
            <div role="tabpanel" class="tab-pane" id="knickknacks">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <p>Mata Ortiz bowl in stand</p>
                    </div>
                    <div class="col-md-4">
                        <img src="/images/2.JPG" class="img-responsive"/>
                        <p>Mata Ortiz bowls</p>
                    </div>
                    <div class="col-md-4">
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script><script src="js/bootstrap.min.js"></script>
</body>
</html>